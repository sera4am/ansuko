...
export const haifun = (text?: string, replacement: string = "‐", expandInterpretation = false): string | null => {
...
export const toHalfWidth = (value: unknown, withHaifun?: string): string | null => {
